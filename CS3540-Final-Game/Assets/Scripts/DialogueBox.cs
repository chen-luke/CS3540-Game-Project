...
public class DialogueBox : MonoBehaviour
{
    ...
    {
        String panel1 = "Hello, explorer! You had quite a crash there. I'm so glad to see that you're okay. My name is GGG and I live here on Khoury.";
    ...
    {
        String panel1 = "Hello, explorer! I saw that crash, earlier. Oh, and it looks like you spoke to GGG already. I'm HHH and I live on Khoury, too.";
        ...
        String panel4 = "You'll have to be cautious, though! I'm assuming GGG told you about the corrupted spawners on the islands. Well, the spawners on this island have been corrupted, too. There are a bunch of angry creatures on this island that like to shoot fireballs.";
        String panel5 = "Good luck, explorer!";
        npc2_dialogue = new string[] { panel1, panel2, panel3, panel4, panel4, panel5 };
    }
    ...
    private void PopulateNPC3()
    {
        ...
        String panel4 = "Oh, and I f-forgot to mention. M-my name is III. G-g-good luck, explorer!";
        npc3_dialogue = new string[] { panel1, panel2, panel3, panel4, panel4 };
    }
