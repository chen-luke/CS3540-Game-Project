...
// behavior for the super boots pickup object
public class BootsPickUpBehavior : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        gameObject.SetActive(!LevelManager.bootsPickedUp);
    }
    ...
    // animate idle behavior of boots
    ...
    // get picked up when player collides with it
